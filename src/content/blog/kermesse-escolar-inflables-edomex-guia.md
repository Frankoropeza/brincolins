...
heroImageAlt: "Kermesse escolar con inflables en Edomex — BRINCOLINS"
intro:
...
tags:
  ...
  - "kermesse escolar inflables Edomex"
  - "inflables kermesse Tlalnepantla"
  - "kermesse escolar organización"
  - "renta inflables Edomex"
faqs:
...
### [Barco Pirata](/inflables/barco-pirata/) — $2,500
...
### [Extremo](/inflables/extremo/) — $3,000
...
6. Confirmar la reservación de inflables con anticipo
7. Diseñar el layout del espacio: dónde va cada inflable, dónde van los puestos de comida
8. Comunicar a los padres de familia la fecha y actividades de la kermesse
9. Asignar maestros y padres voluntarios como responsables de cada inflable
10. Planear el sistema de turnos por grado para evitar aglomeraciones

### 2 semanas antes

11. Verificar los requerimientos eléctricos de los inflables con BRINCOLINS
12. Confirmar el acceso para el vehículo de entrega de inflables (portón, ancho de entrada)
13. Definir el protocolo de seguridad y las reglas de uso de los inflables
14. Imprimir boletos o fichas de turno para los alumnos
15. Confirmar el número de voluntarios adultos para supervisión

### 1 semana antes

16. Confirmar la reservación final con BRINCOLINS (WhatsApp 5531281706)
17. Verificar que el espacio esté libre de obstáculos para la instalación
18. Preparar el área eléctrica: extensiones, multicontactos, acceso al tablero
19. Comunicar a los maestros el procedimiento de turno de inflables por grado
20. Designar un coordinador de inflables para el día del evento

### 3 días antes

21. Confirmar el horario de llegada del equipo de BRINCOLINS
22. Preparar un espacio de estacionamiento para el vehículo de entrega
23. Revisar el pronóstico del tiempo y tener un plan de contingencia
24. Imprimir el checklist del día del evento para el coordinador de inflables
25. Preparar el área de primeros auxilios básicos

### Día de la kermesse

26. Recibir al equipo de BRINCOLINS y acompañarlos durante la instalación
27. Verificar que cada inflable esté correctamente inflado y anclado antes de abrir
28. Iniciar el sistema de turnos según el horario planificado
29. Mantener supervisión adulta constante en cada inflable durante todo el evento
30. Registrar incidentes o observaciones para el reporte post-evento
...
| Número de inflables | Tiempo de llegada recomendado | Tiempo de instalación | Buffer de seguridad |
|---|---|---|---|
| 1 inflable | 60 min antes del inicio | 20-25 min | 35-40 min |
| 2 inflables | 90 min antes del inicio | 35-45 min | 45-55 min |
| 3 inflables | 2 horas antes del inicio | 50-70 min | 50-70 min |
| 4 o más inflables | 2.5 horas antes del inicio | 80-100 min | 50-70 min |
